---
description: OpenTofu public modules vs custom modules
---
...
* [https://github.com/osinfra-io/pt-arche-google-project/issues/1](https://github.com/osinfra-io/pt-arche-google-project/issues/1)

</details>

## Context and Problem Statement

An [OpenTofu module](https://opentofu.org/docs/language/modules/) is a great resource for describing the architecture and keeping infrastructure as code [DRY](https://en.wikipedia.org/wiki/Don't\_repeat\_yourself). Open-source modules are published to [search.opentofu.org](https://search.opentofu.org/). Should we consume OpenTofu public modules or develop custom modules?
...
* Align with OpenTofu [documentation](https://opentofu.org/docs/language/modules/develop/).
* Single testing framework.

## Considered Options

<table data-view="cards"><thead><tr><th></th><th data-type="rating" data-max="5"></th></tr></thead><tbody><tr><td>Use OpenTofu public modules.</td><td>2</td></tr><tr><td>Development of custom OpenTofu modules.</td><td>5</td></tr><tr><td>Combination of both.</td><td>1</td></tr></tbody></table>

## Decision Outcome

Option 2: Development of custom OpenTofu modules to fit the needs of the organization and the skills of the employees&#x20;

## Pros and Cons of the Options

### Use OpenTofu public modules
...
### Development of custom OpenTofu modules
