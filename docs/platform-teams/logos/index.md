...
- **[Resource Hierarchy](./resource-hierarchy)**: GCP folder structure with environment-scoped folders for sandbox, non-production, and production
- **[Identity & Access](./identity-access)**: Google Identity groups and centralized user management
- **[Team Topology](./team-topology)**: GitHub teams and repositories, Datadog teams, and branch protection
