...
<Tabs>
  <TabItem value="active" label="Active Clusters (11)" default>
    ...
    <CardGrid>
      ...
      <NetworkCard cluster="et-test-us-east1-b" logo="/img/gke.svg" primary="10.60.128.0/20" pods="10.16.0.0/15" services="10.62.96.0/20" master="10.63.192.128/28" />
      <NetworkCard cluster="et-test-us-east1-c" logo="/img/gke.svg" primary="10.60.144.0/20" pods="10.18.0.0/15" services="10.62.112.0/20" master="10.63.192.144/28" />
      <NetworkCard cluster="et-test-us-east1-d" logo="/img/gke.svg" primary="10.60.160.0/20" pods="10.20.0.0/15" services="10.62.128.0/20" master="10.63.192.160/28" />
    </CardGrid>
